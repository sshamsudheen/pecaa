namespace :import do
  task :permissions => :environment do
    ...
    ["Users Management","Roles Management", "Sites Management",
      ...
      "Texts Management","Site_Styles Management","site_users","Site_Ecomm Management","Products Management", "Payments Management","System_Configs Mangement"].each do |sub_per|
