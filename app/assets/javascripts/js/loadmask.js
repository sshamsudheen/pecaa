...
//                		'<span style="" class=\"ui-overlay-loading\">' + label + '</span>');
                maskMsgDiv.append('<div style="padding-left: 20px; background-image:url(/assets/images/loading.gif);background-repeat: no-repeat;background-position: center left" class=\"ui-overlay-loading\">' + label + '</div>');
